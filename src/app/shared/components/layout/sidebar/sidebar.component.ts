  ...
  template: `
    <aside class="flex h-screen w-64 flex-col border-r bg-background">
      ...
      <nav class="flex-1 space-y-1 overflow-y-auto px-3 py-4">
        <!-- Management Section -->
        <div class="pb-2">
          <h3 class="mb-2 px-3 text-xs font-medium text-muted-foreground">Management</h3>
        ...
        <!-- Analytics Section -->
        <div class="pb-2 pt-4">
          <h3 class="mb-2 px-3 text-xs font-medium text-muted-foreground">Analytics</h3>
          <div class="space-y-0.5">
            <a
              routerLink="/metrics"
              routerLinkActive="bg-secondary text-secondary-foreground"
        ...
        <!-- Automation Section -->
        <div class="pb-2 pt-4">
          <h3 class="mb-2 px-3 text-xs font-medium text-muted-foreground">Automation</h3>
          <div class="space-y-0.5">
            <a
              routerLink="/agents"
              routerLinkActive="bg-secondary text-secondary-foreground"
