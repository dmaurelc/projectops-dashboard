      ...
      <div class="container-custom max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-2xl font-bold text-gray-900 mt-1">{{ taskService.tasks().length }}</p>
              </div>
          ...
          <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
              <div>
                <p class="text-xs font-medium text-gray-500 uppercase tracking-wide">High Priority</p>
                <p class="text-2xl font-bold text-orange-600 mt-1">{{ highPriorityCount() }}</p>
              </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
            ...
            <span class="inline-flex items-center justify-center min-w-[32px] h-7 px-3 bg-primary-100 text-primary-700 rounded-full text-sm font-bold">
          ...
          <div class="p-4">
            <div class="space-y-3">
              ...
              <!-- Empty State -->
              <div *ngIf="taskService.tasks().length === 0" class="flex flex-col items-center justify-center py-16">
                <div class="w-20 h-20 mb-6 rounded-full bg-gradient-to-br from-primary-100 to-accent-100 flex items-center justify-center">
...
export class TasksListComponent implements OnInit {
  ...
  highPriorityCount = computed(() =>
    this.taskService.tasks().filter(t => t.priority === 'high' || t.priority === 'critical').length
  );
